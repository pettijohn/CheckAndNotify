...
# Keep this project's Docker auth separate from any VS Code/devcontainer
# generated Docker config, which may reference credential helpers that are not
# installed in this image.
mkdir -p "${DOCKER_CONFIG:-$HOME/.docker-checkandnotify}"
chmod 700 "${DOCKER_CONFIG:-$HOME/.docker-checkandnotify}"
